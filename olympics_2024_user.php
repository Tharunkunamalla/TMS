    ...
    <header>
            ...
            <ul>
                <li><i class="fa-solid fa-house"></i><a
                        href="index1.html">Home</a></li>
                <!-- Events Dropdown -->
                <li class="events-dropdown">
                    <i class="fa-solid fa-calendar-days"></i>
                    <a href="#event">Events <i
                            class="fa-solid fa-chevron-down dropdown-arrow"></i></a>
                    <ul class="dropdown-menu">
                        <li><a href="olympics_2024_user.php">Olympics
                                2024</a></li>
                    ...
                    <tbody>
                        <?php if ($stmt->rowCount() > 0): ?>
                            <?php while($row = $stmt->fetch(PDO::FETCH_ASSOC)): ?>
                                <tr>
                                    <td>
                                        <a class="table_items" href="players_user.php?sport_id=<?= htmlspecialchars($row['Sport_id']) ?>">
